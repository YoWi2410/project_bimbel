                    ...
                    <div class="card-body">
                        <form action="{{route('admin.discount.update', $discount->id)}}" method="post">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input name="code" type="text" class="form-control {{$errors->has('name') ? 'is-invalid': ''}}" value="{{old('code') ?: $discount->code}}" required/>
                                @if ($errors->has('code'))
                            ...
                            <div class="form-group mb-4">
                                ...
                                <textarea name="description" cols="0" rows="2" class="form-control {{$errors->has('name') ? 'is-invalid': ''}}">{{old('description') ?: $discount->description}}</textarea>
